...
import com.jetpack.submission1.data.source.remote.response.MovieImageResponse
...
object DataDummyMovie {
    fun generateDummyMovie(): ArrayList<MovieEntity> {
        ...
        movie.add(MovieEntity(
            ...
            "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/oL3T7lc9NgB3tHP0lhSlyVsRMV2.jpg",
        ...
        movie.add(MovieEntity(
            ...
            "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/dbvAUZWOepRxwUnSOvZAGsrPjta.jpg",
        ...
        movie.add(MovieEntity(
            ...
            "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/7usAXeMgdShhJka7iUGsM6uKqKG.jpg",
    ...
    fun getDummyMovieById():MovieByIdResponse=
        MovieByIdResponse(
            "hi",
            "tt0112870",
            false,
    ...
    fun getDummyMovieImage(): MoviePostersItem =
        MoviePostersItem(
            0.6666666666666666,
            "/2CAL2433ZeIihfX1Hb2139CX0pW.jpg",
            5.774,
