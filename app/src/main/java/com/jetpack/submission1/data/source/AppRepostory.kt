...
class AppRepostory private constructor(private val remoteDataSource: RemoteDataSource) : AppDataSource {
    companion object {
        @Volatile
        private var instance: AppRepostory? = null
        fun getInstance(remoteData: RemoteDataSource): AppRepostory =
            instance ?: synchronized(this) {
                instance ?: AppRepostory(remoteData).apply { instance = this }
            }
    }
